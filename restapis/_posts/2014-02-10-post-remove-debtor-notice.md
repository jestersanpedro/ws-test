...
path: '/api/deleteDebtorNotice'
title: 'Delete debtor notice'
type: 'POST'

layout: nil
---

## deleteDebtorNotice Method

### Overview

> This method will be used for removing an invoice detail and attachment.
...
* This will be used on removing an invoice detail and attachment.
  ...
  "Transaction":{
    "Import":{
      "Details":{
        ...
        "ReceiptNumber":"0",
        "ReceiptAmount":"0",
        "ReceiptDebtorNoticeDate":"12/12/2013",
        "MeetingID":"1117",
        "CommonID":"738",
        "DebtorRunID":"0",
